...
| Estado visual en tienda | `ShopRequirementsUI` en `EndScene/ShopCanvas/.../ShopContent/Requirements`: stock/mínimo de carne y carbón, cuánto falta, y la racha (`"NOCHES SEGUIDAS CON STRIKES: N / M"`, auto-size 16–20 para entrar en su caja), en 2×2. Verde/rojo según se cumpla. Fuente **Bungee** (tiene acentos; ver nota 30) sobre `Fondo para Textos Corto` en `Sliced` |
