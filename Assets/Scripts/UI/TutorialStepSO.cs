...
public class TutorialStepSO : ScriptableObject
{
    ...
    [Tooltip("Si est� activo, un estado m�s cocido que el pedido tambi�n cuenta como alcanzado.")]
    public bool acceptHigherDonenessAsReached;
    [Min(1)]
    [Tooltip("Cantidad de niveles menos cocidos que tambi�n se aceptan. Usar 1 para permitir un nivel menos.")]
